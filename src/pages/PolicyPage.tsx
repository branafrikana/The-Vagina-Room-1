...
export default function PolicyPage() {
  ...
  let sections = [];
  try {
    sections = JSON.parse(content.policySectionsJson || '[]');
  } catch (e) {
    console.error("Failed to parse policy sections", e);
  }
      ...
      <main className="max-w-4xl mx-auto px-6 py-20 pb-32">
        <div className="flex items-center space-x-4 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">
            <EditableText field="policyHeading" className="inline-block" />
          </h1>
        </div>
        ...
        <div className="prose prose-invert prose-brand max-w-none space-y-8 text-white/80 font-light leading-relaxed">
          ...
          <div className="whitespace-pre-wrap">
            <EditableText field="policyIntro" multiline />
          </div>
